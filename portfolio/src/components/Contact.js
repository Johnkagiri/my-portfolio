...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-screen bg-[#070708] flex justify-center items-center p-4"
    >
      <form
        method="POST"
        action="https://getform.io/f/dddfdeca-ebdb-4820-8373-adc0fd42cc87"
